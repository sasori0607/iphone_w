...
$('.you_basket .main .content .minus').click(function(){
   ...
   console.log(coverings)
   let modelCase = mains.find('.modelCase').val()
...
function Price() {
    ...
    console.log(connector)
    let modelCase =  $('.modelCase button[disabled] p').html()
    console.log(modelCase, 'modelCase')
...
$('.body0').click(function(){
    let ref = $(this).find('.ref').attr('href')
...
$('.img_menu').click(function(){
    $('.nav .menu').animate({'left':'0px'},1000)
})

$('.clos').click(function(){
    $('.nav .menu').animate({'left':'-100%'}, 1000)
})
...
$('.modelCase button').click(function(){
    $('.modelCase button').attr('disabled', false)
    $(this).attr('disabled', true)
    Price()
})
...
$('.r-raw').click(function(){

    let s = $('.category_menu').scrollLeft()
    $('.category_menu').animate({scrollLeft:s+150}, 300)


})

$('.l-raw').click(function(){
